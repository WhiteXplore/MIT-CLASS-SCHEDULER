<template>
  ...
  >
    <!-- Left Section -->
    <div class="flex items-center justify-end lg:justify-between w-full md:w-auto">
    ...
    <!-- Profile Dropdown -->
    <div v-if="isOpenProfile" ref="profileDropdown" class="fixed top-16 right-4 z-[9999]">
      <Profile />
    </div>
  </div>
</template>
