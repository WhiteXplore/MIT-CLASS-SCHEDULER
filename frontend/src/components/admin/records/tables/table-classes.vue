<template>
  <div v-if="isTable" class=" ">
    <div class="text-sm flex justify-between">
      ...
      <div
        @click="toggleAdd"
        class="cursor-pointer flex gap-2 items-center tracking-wider bg-green-600 text-white hover:text-green-700 p-3 py-2 rounded-md hover:bg-green-300 hover:shadow-lg"
      >
            ...
            <div class="w-full mt-3 rounded-xl shadow-md overflow-hidden">
              ...
              >
                ...
                >
                  ...
                  >
                    <tr>
                      <th class="w-[50px] px-5 py-3 text-center border-b">
                        ID
                      </th>
