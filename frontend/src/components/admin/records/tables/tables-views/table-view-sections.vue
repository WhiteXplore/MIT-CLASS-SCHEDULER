          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.section_session || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.section_set || "-" }}
                </td>
...
export default {
  ...
  computed: {
    ...mapState(useFetchDataStore, ["detailedSections"]),

    filteredData() {
      const query = this.searchQuery.toLowerCase();
      return this.detailedSections.filter((item) => {
  ...
  methods: {
    ...
    async loadViews() {
      ...
      await store.fetchDetailedSections();
    },
    toggleUploadData() {
