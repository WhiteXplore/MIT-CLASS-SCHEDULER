          ...
          >
            ...
            >
              <tr>
                ...
                <th class="px-4 py-3 text-left font-normal">Laboratory</th>
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.curriculum_name || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.course_code || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.course_description || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.course_semester || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.course_level || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.course_lec || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.course_lab || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.course_requisite || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
...
export default {
  ...
  computed: {
    ...mapState(useFetchDataStore, ["detailedCourses"]),

    filteredData() {
      const query = this.searchQuery.toLowerCase();
      return this.detailedCourses.filter((item) => {
  ...
  methods: {
    ...
    async loadViews() {
      ...
      await store.fetchDetailedCourses();
    },
