          ...
          >
            ...
            >
              <tr>
                ...
                <th class="px-4 py-3 text-left font-normal">Instructor</th>
                <th class="px-4 py-3 text-left font-normal">Job Type</th>
                <th class="px-4 py-3 text-left font-normal">
                  Bachelor Category
                </th>
                <th class="px-4 py-3 text-left font-normal">Bachelor Type</th>
                <th class="px-4 py-3 text-left font-normal">Master Category</th>
                <th class="px-4 py-3 text-left font-normal">Master Type</th>
                <th class="px-4 py-3 text-left font-normal">
                  Doctorate Category
                </th>
                <th class="px-4 py-3 text-left font-normal">Doctorate Type</th>
                <th class="px-4 py-3 text-left font-normal">Room</th>
                <th class="px-4 py-3 text-left font-normal">Days</th>
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-4 py-3 text-left">
                  {{
                    (view_all_data.instructor_fname || "") +
                    " " +
                    (view_all_data.instructor_lname || "")
                  }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.instructor_jobtype || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.bachelor_category || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.bachelor_type || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.master_category || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.master_type || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.doctorate_category || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.doctorate_type || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
                  {{ view_all_data.room_name || "-" }}
                </td>
                <td class="px-4 py-3 text-left">
...
export default {
  ...
  computed: {
    ...mapState(useFetchDataStore, ["detailedInstructor"]),

    filteredData() {
      const query = this.searchQuery.toLowerCase();
      return this.detailedInstructor.filter((item) => {
  ...
  methods: {
    ...
    async loadViews() {
      ...
      await store.fetchDetailedInstructor();
    },
