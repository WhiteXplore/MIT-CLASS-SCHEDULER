<template>
  <div v-if="isTable" class=" ">
    <div class="text-sm flex justify-between">
      ...
      >
        ...
        <span class="font-medium text-sm">Add Doctorate</span>
      </div>
    </div>
            ...
            <div class="w-full rounded-xl shadow-md overflow-hidden">
              ...
              >
                ...
                >
                  ...
                  <tbody>
                    <tr
                      v-for="(doctorate_program_data, index) in paginatedData"
                      :key="doctorate_program_data.doctorateprogram_id"
  ...
  <adddoctorateProgram v-if="isAdd" @close="closeView" />
  <editDoctorate
    v-if="isEdit"
    :doctorateProgram="editItem"
...
import adddoctorateProgram from "../modals/add-doctorate-programs.vue";
import editDoctorate from "../modals/edit-doctorate.vue";
import { toast } from "vue3-toastify";
import { useFetchDataStore } from "../../../../store/fetch-data-store";
import { mapState } from "pinia";
import axios from "axios";
export default {
  name: "TableDoctoratePrograms",
  components: {
    adddoctorateProgram,
    icon,
    editDoctorate,
  ...
  computed: {
    ...mapState(useFetchDataStore, ["doctorates"]),
  ...
  methods: {
    async loadDoctorates() {
      const store = useFetchDataStore();
      await store.fetchDoctorates();
    },
    toggleAdd() {
      this.isAdd = true;
      this.isTable = true;
    ...
    confirmDelete() {
      if (!this.recordToDelete || !this.recordToDelete.doctorateprogram_id) {
    ...
    handleBackToTable() {
      ...
      this.isTable = true;
      this.editItem = null;
      this.loadDoctorates(); // reload list after edit
    },
  },
  mounted() {
    this.loadDoctorates();
