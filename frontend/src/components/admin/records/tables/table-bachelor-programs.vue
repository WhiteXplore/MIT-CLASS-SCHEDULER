<template>
  <div v-if="isTable" class=" ">
    <div class="text-sm flex justify-between">
      ...
      >
        ...
        <span class="font-medium text-sm">Add Bachelor</span>
      </div>
    </div>
            ...
            <div class="w-full rounded-xl shadow-md overflow-hidden">
              ...
              >
                ...
                >
                  ...
                  <tbody>
                    <tr
                      v-for="(bachelor_program_data, index) in paginatedData"
                      :key="bachelor_program_data.bachelorprogram_id"
  ...
  <addbachelorProgram v-if="isAdd" @close="closeView" />
  <editBachelor
    v-if="isEdit"
    :bachelorProgram="editItem"
...
import addbachelorProgram from "../modals/add-bachelor-programs.vue";
import editBachelor from "../modals/edit-bachelor.vue";
...
export default {
  ...
  computed: {
    ...mapState(useFetchDataStore, ["bachelors"]),
  ...
  methods: {
    ...
    confirmDelete() {
      if (!this.recordToDelete || !this.recordToDelete.bachelorprogram_id) {
      ...
      axios
        ...
        .then(() => {
          ...
          this.loadBachelors(); // Refresh list after delete
    ...
    toggleEdit(item) {
      this.isEdit = true;
      this.isTable = true;
      this.editItem = item; // Store the current item to pass to edit modal
    },
    ...
    handleBackToTable() {
      ...
      this.isEdit = false;
      this.editItem = null;
      this.loadBachelors(); // reload data after edit
    },
  },
  mounted() {
    this.loadBachelors();
