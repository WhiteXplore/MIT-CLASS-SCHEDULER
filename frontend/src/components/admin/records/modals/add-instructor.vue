<template>
  ...
  >
    <div class="rounded-[15px] shadow-lg bg-white text-[13px] w-auto">
      <form
          ...
          <div v-if="currentStep === 2">
            ...
            <div class="w-[25vw] text-left gap-3 flex flex-col mt-2">
              <div class="w-full space-y-2">
                ...
                <select
                  v-model.number="form.bachelorprogram_id"
              ...
              <div class="w-full space-y-2">
                ...
                <select
                  v-model.number="form.masterprogram_id"
                  id="masterprogram_id"
                  class="w-full border px-2 py-3 border-gray-600 rounded-md text-md text-gray-800"
                >
                  <option :value="0">-</option>
              ...
              <div class="w-full space-y-2">
                ...
                <select
                  v-model.number="form.doctorateprogram_id"
    ...
    nextStep() {
      if (this.currentStep === 1) {
        const personalFieldsFilled =
          this.form.instructor_fname &&
          this.form.instructor_lname &&
          this.form.instructor_gender;
